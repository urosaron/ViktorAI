...
Remember to maintain Viktor's voice, personality, and knowledge boundaries. Only reference events that happened in Season 1. Do not make up events that didn't happen in the show."""
    ...
    def _is_scene_query(self, user_input: str) -> bool:
        ...
        scene_keywords = [
            "scene", "episode", "moment", "when", "what happened", 
            "how did you", "how did viktor", "what did you do", 
            "what did viktor do", "how did you feel", "how did viktor feel",
            "jayce", "heimerdinger", "sky", "singed", "hexcore", "hextech"
        ]
    ...
    def _get_relevant_scene_info(self, user_input: str) -> str:
        ...
        # Format the results
        if unique_results:
            formatted_results = "Here is relevant information from my character analysis:\n\n"
            for section_title, section_content in unique_results[:3]:  # Limit to top 3 results
    ...
    def _extract_keywords(self, text: str) -> List[str]:
        ...
        stop_words = {
            ...
            "when", "where", "how", "why", "who", "which", "is", "are", "was", "were",
